...
public class UnsignedBuffer {
    ...
    public static void main(String[] argv)
        ...
        buffer.clear();
        UnsignedBuffer.putUnsignedByte(buffer, 255);
        UnsignedBuffer.putUnsignedByte(buffer, 128);
        UnsignedBuffer.putUnsignedShort(buffer, 0xcafe);
        UnsignedBuffer.putUnsignedInt(buffer, 0xcafebabe);
